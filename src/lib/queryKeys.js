...
export const queryKeys = {
  ...
  contracts: {
    ...
    templatesForCell: (region, stayType) => ['contracts', 'templates', 'cell', region, stayType],
    templates: (params = {}) => ['contracts', 'templates', 'list', params],
    mergeFields: () => ['contracts', 'merge-fields'],
    forBooking: (bookingId) => ['contracts', 'booking', bookingId],
    list: (params = {}) => ['contracts', 'list', params],
    unsent: (params = {}) => ['contracts', 'unsent', params],
    summary: () => ['contracts', 'summary'],
    detail: (id) => ['contracts', 'detail', id],
    events: (id) => ['contracts', 'events', id],
  },
  finance: {
    all: ['finance'],
