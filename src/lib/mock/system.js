...
export const helpArticles = [
  ...
  { id: 'help-invoice', category: 'Bookings & guests', title: 'Viewing and downloading a booking’s invoice', body: 'Open a booking from the Bookings table and click "View invoice" next to Payments. It opens a receipt with the guest, property, stay, line items and settled payments — click "Download PDF" to save it as a one-page A4 file, or "Print" to send it straight to a printer. The company name, support email and legal address shown on it come from Settings → Invoicing.' },
